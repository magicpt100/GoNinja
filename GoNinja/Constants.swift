...
let HSButtonPosYFactor:CGFloat = 220.0/375.0
let settingsButtonPosYFactor:CGFloat = 185.0/375.0
let buttonWidthFactor:CGFloat = 120.0/667.0
let buttonHeightFactor:CGFloat = 30.0/375.0
let HSBackButtonPosXFactor:CGFloat = 300.0/667.0
